...
def init_app(app: FastAPI):
    ...
    task_routes.add_api_route(
        "/status/{task_id}/live", live_task_status, methods={"GET"}
    )

    tasks_routes.add_api_route("/status", get_all_tasks_status, methods={"GET"})
    tasks_routes.add_api_route("/status/live", live_all_task_status, methods={"GET"})
