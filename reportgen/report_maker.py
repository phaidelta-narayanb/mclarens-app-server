...
class ReportMaker:
    ...
    async def from_template_async(self, report_template: str, **context_args) -> str:
        context = {
            "current_date": get_date_string(),
            **self.additional_static_kwargs,
            **context_args
        }
        return await self.template_env.get_template(report_template).render_async(context)
